...
def input_Data():
    ...
    fieldValues = ["KuNA","123456","CS/HSKA063/034W/240F-0841","0815","0070027200","0002","34","4530","","",today,"ich"]  # Vorbelegung der Eingabefelder # nur für Faulheit
...
def read_data_make_plot(Excel_Path, spinDat, sc):
    ...
    actFilePath, actFileName = os.path.split(os.path.abspath(__file__))
...
# def CreateWord(spinDat, spinType, Excel_Path):
#     l_tpl = Word_Path 
#     docx_tpl = DocxTemplate(l_tpl)
#     imag_path = Excel_Path
...
#         'DB' : spinDat['DBL.Nr.'],
#         'Motortyp' : spinType,
#         'SpindelP' : spinDat['Nennleistung'],
#         'Nn' : spinDat['Nenndrehzahl'],
#         'Nmax':spinDat['max.Drehzahl'],
#         'Pr' : spinDat['Prüfer/in'],
#         'date' : spinDat["Prüfdatum"],
#         'Pr' : ["Prüfer/in"],
#         'R_Temp' : ["Raumtemperatur [°C]"]
#         'bild' : img,
#     }
