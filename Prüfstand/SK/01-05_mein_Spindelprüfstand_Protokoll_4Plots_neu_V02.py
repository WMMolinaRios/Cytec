...
def input_Data():
    ...
    fieldNames = ["Kundenname","Kommissionsnummer","Spindelbezeichnung","AS-Nr.","Motorbez.","DBL.Nr. 204-","Nennleistung [kW]","Nenndrehzahl [1/min]","max.Drehzahl [1/min]","Prüfer/in"]
    ...
    # make sure that none of the fields was left blank and correct input
    while 1:
    ...
    # print('fieldValues') #DEBUG
    # print(fieldValues) #DEBUG
    # print(fieldValues[1]) #DEBUG
    # print('Länge') #DEBUG
    # print(len(fieldValues[1])) #DEBUG
    # print(type(fieldValues[1])) #DEBUG
    # print('') #DEBUG
    
    
    genDat = dict(zip(fieldNames, fieldValues))
    #print('Spindelbezeichnung = ' + genDat['Spindelbezeichnung']) #DEBUG
...
def read_data_make_plot(Excel_Path, KommNr, sc):
    #----------Eingabe des Dateinamen, der Endung sowie der Überspringenden Endungen----------
    #filename =  '2022.01.25 - 50kw s1 test 20220125'                                      # Name der Auszulesenden csv Datei
    filename =  Excel_Path
    ...
    #df_legend = pd.read_csv('data/' + str(filename) + '.csv' ,sep=",",nrows=legend-2, encoding = 'latin2')
    ...
    fig.suptitle((KommNr + name), fontsize=24, y =1.00)
...
def main():
    ...
    print(spindleData) #DEBUG
    
    genDat = spindleData[0]
    spinType = spindleData[1]
    
    print('') #DEBUG
    print(genDat['Kommissionsnummer']) #DEBUG
    print(spinType) #DEBUG
    print('') #DEBUG
    #print(spindleData[0]) #DEBUG
    #print(spindleData[1]) #DEBUG
    
    #Auswahl der Messsignale
    sc = signal_Choice()
    if 'Motortemp r35' in sc: #DEBUG
        print('sc-Motortemp True') #DEBUG
    else: #DEBUG
        print('sc-Motortemp False') #DEBUG
    print('signal_choice') #DEBUG
    print(sc) #DEBUG
    print('') #DEBUG

    #Daten lesen und Graph generieren
    fig = read_data_make_plot(Excel_Path, genDat['Kommissionsnummer'], sc)
    
    #Plot speichern
    default_filename = genDat['Kommissionsnummer']
