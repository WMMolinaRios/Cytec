...
def input_Data():
    ...
    fieldValues = ["KuNA","123456","CS/HSKA063/034W/240F-0841","0815","0070027200","0002","34","4530","24000","23" ,today,"ich"]  # Vorbelegung der Eingabefelder # nur für Faulheit
...
def read_data_make_plot(Excel_Path, spinDat, sc):
    ...
    legend   = 14 
                                        ...
                                        # Wie viele Zeilen am Anfang übersprungen werden sollen
